...
本实验主要介绍网络套接字（Socket）和网络字节序，以及 Socket 网络模型的创建流程，最后分别通过 C 语言 和 Go 语言来实现 TCP-C/S 模型，同时会提供完整的示例代码供大家学习和实操。
...
![7](./picture3/server-client-run.jpeg)
...
![8](./picture3/server-client-go-run.jpeg)
...
![9](./picture3/nb-server-client.jpeg)
